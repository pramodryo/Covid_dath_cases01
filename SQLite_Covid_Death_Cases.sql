...
--CREATE TABLE High_death as  SELECT "state/ut", active_cases , death FROM C19INDIA ORDER by death DESC limit 10;
...
--CREATE table Less_active_cass as select "state/ut", active_cases FROM C19INDIA where active_cases <= 5;
